...
suite("TOC.", () => {
    ...
    test("Create", () => {
        return (0, generic_1.testCommand)('markdown.extension.toc.create', [
            '# Section 1',
            '',
            '## Section 1.1',
            '',
            ...
            '',
            ''
        ], new vscode_1.Selection(6, 0, 6, 0), [
            '# Section 1',
            '',
            '## Section 1.1',
            '',
            ...
            '- [Section 2](#section-2)',
            '',
        ], new vscode_1.Selection(9, 0, 9, 0));
    });
    test("Update", () => {
        return (0, generic_1.testCommand)('markdown.extension.toc.update', [
            '# Section 1',
            '',
            '## Section 1.1',
            '',
    ...
    test("Update (ordered list)", async () => {
        await (0, configuration_1.updateConfiguration)({ config: [["markdown.extension.toc.orderedList", true]] });
        await (0, generic_1.testCommand)('markdown.extension.toc.update', [
            '# Section 1',
            '',
            '## Section 1.1',
            '',
    ...
    test("Create (levels 2..3)", async () => {
        await (0, configuration_1.updateConfiguration)({ config: [["markdown.extension.toc.levels", "2..3"]] });
        await (0, generic_1.testCommand)("markdown.extension.toc.create", [
            '# Section 1',
            '',
            '## Section 1.1',
            '',
            ...
            '',
            ''
        ], new vscode_1.Selection(16, 0, 16, 0), [
            '# Section 1',
            '',
            '## Section 1.1',
            '',
            ...
            '',
        ], new vscode_1.Selection(20, 0, 20, 0));
        await (0, configuration_1.resetConfiguration)();
    });
    ...
    test("Ordered list (list markers larger than 9)", async () => {
        ...
        await (0, generic_1.testCommand)('markdown.extension.toc.create', [
            ...
            '',
            ''
        ], new vscode_1.Selection(13, 0, 13, 0), [
            '# H1',
            '# H2',
            '# H3',
            '# H4',
            ...
            '       1. [H12](#h12)',
            ''
        ], new vscode_1.Selection(25, 0, 25, 0));
        await (0, configuration_1.resetConfiguration)();
    });
    test("Setext headings", () => {
        return (0, generic_1.testCommand)('markdown.extension.toc.create', [
            ...
            '  - [Section 1.1](#section-11)',
            '',
        ], new vscode_1.Selection(8, 0, 8, 0));
    });
    test("ATX Heading closing sequence", () => {
        return (0, generic_1.testCommand)('markdown.extension.toc.create', [
            ...
            '- [H6 #](#h6-)',
            '',
        ], new vscode_1.Selection(17, 0, 17, 0));
    });
    test("Update multiple TOCs", async () => {
        await (0, configuration_1.updateConfiguration)({ config: [["markdown.extension.toc.slugifyMode", "github"]] });
        await (0, generic_1.testCommand)('markdown.extension.toc.update', [
            '# Head 1',
            '# Head 2',
            '',
    ...
    test("Exclude omitted headings (`toc.omittedFromToc`)", async () => {
        await (0, configuration_1.updateConfiguration)({
            config: [["markdown.extension.toc.omittedFromToc", {
                        [generic_1.Test_Md_File_Path.fsPath]: [
        ...
        await (0, generic_1.testCommand)('markdown.extension.toc.create', [
            ...
            '## Introduction',
            '# Head 4'
        ], new vscode_1.Selection(4, 0, 4, 0));
        await (0, configuration_1.resetConfiguration)();
    });
    ...
    test("<!-- omit from toc --> in previous line", () => {
        return (0, generic_1.testCommand)('markdown.extension.toc.create', [
            ...
            '',
            ''
        ], new vscode_1.Selection(10, 0, 10, 0), [
            '# Section 1',
            '',
            '<!-- omit from toc -->',
            '## Section 1.1',
            ...
            '- [Section 2](#section-2)',
            '',
        ], new vscode_1.Selection(12, 0, 12, 0));
    });
    ...
    test("Markdown syntax in headings", () => {
        return (0, generic_1.testCommand)('markdown.extension.toc.create', [
            ...
            '',
        ], new vscode_1.Selection(18, 0, 18, 0));
    });
    test("Add section numbers", () => {
        return (0, generic_1.testCommand)('markdown.extension.toc.addSecNumbers', [
            '---',
            'title: test',
            '---',
            '# Heading 1',
    ...
    test("Remove section numbers", () => {
        return (0, generic_1.testCommand)('markdown.extension.toc.removeSecNumbers', [
            '---',
            'title: test',
            '---',
            '# 1. Heading 1',
    ...
    test("Section numbering and `toc.levels`", async () => {
        await (0, configuration_1.updateConfiguration)({ config: [["markdown.extension.toc.levels", "2..6"]] });
        await (0, generic_1.testCommand)('markdown.extension.toc.addSecNumbers', [
            '# Heading',
            '## Heading 1',
            '## Heading 2',
            '## Heading 3',
